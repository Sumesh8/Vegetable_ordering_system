...
<body>
    ...
    <div class = "container">
		...
		<div class = "headBox">
			...
			<div class = "lowerbox"> 
				...
				<ul class = "nav"> 
					...
					<a class = "current" href = "customerdt.php"><li>Customer Details</li></a>
		...
		<div class="dscption">
		<div class="sliders">
		<form action="customerdt.php" method="POST">
		    <div class="selector">					
				<div class="tuple">
		    ...
		    <br>
			<div class="heading"> <h2>Display Customer details </h2> </div><br>				
			...
			<th>Contact Number</th>			
				...
				if($result->num_rows>0){
					while($row = $result-> fetch_assoc()){
						if($custName=="" ){
						    echo "<tr><td>".$row["uname"]."</td><td>".$row["fName"]."</td><td>".$row["lName"]."</td><td>".$row["email"]."</td><td>".$row["dob"]."</td><td>".$row["mno"]."</td></tr>";
						}
						else if($row["uname"]==$custName){
						    echo "<tr><td>".$row["uname"]."</td><td>".$row["fName"]."</td><td>".$row["lName"]."</td><td>".$row["email"]."</td><td>".$row["dob"]."</td><td>".$row["mno"]."</td></tr>";
						}
					}
				}
